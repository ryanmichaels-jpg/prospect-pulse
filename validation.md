...
**Expected:** Tier 1
**Our rationale:** Score driven by: 30 SDK/tooling-pattern repos, 2 migration-pattern repos (aave-v3-crosschain-listing-template: 'v3', onramp-v2-mobile-demo: 'v2'), 16 languages, ~3500 employees, fintech vertical.
...
## Upwork — Tier 3 (score: 52)

**Expected:** Tier 1 or 2
**Our rationale:** Score driven by: 8 languages, careers page mentions microservices, platform engineer, platform engineering, 6 open eng roles, ~850 employees, marketplace vertical.
...
## Rippling — Tier 3 (score: 52)

**Expected:** Tier 1
**Our rationale:** Score driven by: 6 languages, ~3000 employees, developer_tools vertical.
